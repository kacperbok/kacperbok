...
namespace ConsoleApp9
{
    class Program
    {
        ...
        {
            string typ = "Przeszukiwanie liniowe - Pesymistyczny - Operacje";

            Console.WriteLine(typ);
            addRecord(typ, "LiniowyPesymistycznyOperacje.csv");
            ...
            for (int i = 0; i <= 30; i++)
            {
                ...
                addRecord("", tabsize, ";", iloscOperacji, "LiniowyPesymistycznyOperacje.csv");
